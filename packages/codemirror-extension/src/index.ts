...
const services: JupyterFrontEndPlugin<IEditorServices> = {
  id: '@evolab/codemirror-extension:services',
...
const commands: JupyterFrontEndPlugin<void> = {
  id: '@evolab/codemirror-extension:commands',
...
export const editorSyntaxStatus: JupyterFrontEndPlugin<void> = {
  id: '@evolab/codemirror-extension:editor-syntax-status',
  autoStart: true,
  ...
  activate: (
    ...
    statusBar.registerStatusItem(
      '@evolab/codemirror-extension:editor-syntax-status',
      {
        item,
        align: 'left',
        rank: 0,
