...
// import {Notebook} from "../../notebook/src";
...
const trackerPlugin: JupyterFrontEndPlugin<INotebookTracker> = {
  id: '@evolab/notebook-extension:tracker',
...
const factory: JupyterFrontEndPlugin<NotebookPanel.IContentFactory> = {
  id: '@evolab/notebook-extension:factory',
...
const tools: JupyterFrontEndPlugin<INotebookTools> = {
  ...
  id: '@evolab/notebook-extension:tools',
  autoStart: true,
...
export const commandEditItem: JupyterFrontEndPlugin<void> = {
  id: '@evolab/notebook-extension:mode-status',
  autoStart: true,
  ...
  activate: (
    ...
    statusBar.registerStatusItem('@evolab/notebook-extension:mode-status', {
      item,
      align: 'right',
      rank: 4,
      isActive: () =>
...
export const notebookTrustItem: JupyterFrontEndPlugin<void> = {
  id: '@evolab/notebook-extension:trust-status',
  autoStart: true,
  requires: [INotebookTracker],
  optional: [IStatusBar],
  activate: (
    ...
    statusBar.registerStatusItem(
      '@evolab/notebook-extension:trust-status',
      {
        item,
        align: 'right',
        rank: 3,
...
const widgetFactoryPlugin: JupyterFrontEndPlugin<NotebookWidgetFactory.IFactory> = {
  id: '@evolab/notebook-extension:widget-factory',
...
function addCommands(
  ...
  commands.addCommand(CommandIDs.runAndAdvance, {
    ...
    execute: args => {
      ...
      if (current) {
        ...
        return NotebookActions.runAndAdvance(current.comm,content, context.sessionContext);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.run, {
    ...
    execute: args => {
      ...
      if (current) {
        ...
        return NotebookActions.run(current.comm,content, context.sessionContext);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.runAndInsert, {
    ...
    execute: args => {
      ...
      if (current) {
        ...
        return NotebookActions.runAndInsert(current.comm,content, context.sessionContext);
      }
    },
    isEnabled
  });
  ...
  commands.addCommand(CommandIDs.runAll, {
    ...
    execute: args => {
      ...
      if (current) {
        ...
        return NotebookActions.runAll(current.comm,content, context.sessionContext);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.runAllAbove, {
    ...
    execute: args => {
      ...
      if (current) {
        ...
        return NotebookActions.runAllAbove(current.comm,content, context.sessionContext);
      }
    },
    isEnabled: () => {
  ...
  commands.addCommand(CommandIDs.runAllBelow, {
    ...
    execute: args => {
      ...
      if (current) {
        ...
        return NotebookActions.runAllBelow(current.comm,content, context.sessionContext);
      }
    },
    isEnabled: () => {
            ...
            if (restarted) {
              void NotebookActions.runAllAbove(
                ...
                if (executed || content.activeCellIndex === 0) {
                  void NotebookActions.run(current.comm,content, context.sessionContext);
                }
              });
            }
          });
    ...
    execute: args => {
      ...
      if (current) {
        ...
        return sessionDialogs!.restart(sessionContext).then(restarted => {
          if (restarted) {
            void NotebookActions.runAll(current.comm,content, context.sessionContext);
          }
          return restarted;
        });
      }
  ...
  commands.addCommand(CommandIDs.toCode, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.changeCellType(current.content, 'code',current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.toMarkdown, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.changeCellType(current.content, 'markdown',current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.toRaw, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.changeCellType(current.content, 'raw',current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.cut, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.cut(current.content,current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.copy, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.copy(current.content,current.comm);
      }
    },
    isEnabled
  });
  ...
  commands.addCommand(CommandIDs.deleteCell, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.deleteCells(current.content,current.comm);
      }
    },
    isEnabled
  });
  ...
  commands.addCommand(CommandIDs.insertAbove, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.insertAbove(current.content,current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.insertBelow, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.insertBelow(current.content,'code',current.comm);
      }
    },
    isEnabled
  });
  ...
  commands.addCommand(CommandIDs.markdown1, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.setMarkdownHeader(current.content, 1,current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.markdown2, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.setMarkdownHeader(current.content, 2,current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.markdown3, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.setMarkdownHeader(current.content, 3,current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.markdown4, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.setMarkdownHeader(current.content, 4,current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.markdown5, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.setMarkdownHeader(current.content, 5,current.comm);
      }
    },
    isEnabled
  });
  commands.addCommand(CommandIDs.markdown6, {
    ...
    execute: args => {
      ...
      if (current) {
        return NotebookActions.setMarkdownHeader(current.content, 6,current.comm);
      }
    },
    isEnabled
  });
...
function populateMenus(
  ...
  mainMenu.runMenu.codeRunners.add({
    ...
    runAll: current => {
      const { context, content } = current;
      return NotebookActions.runAll(current.comm,content, context.sessionContext)!.then(
        () => void 0
      );
    },
