...
const browser: JupyterFrontEndPlugin<void> = {
  ...
  id: '@evolab/filebrowser-extension:browser',
  requires: [
    IFileBrowserFactory,
    IDocumentManager,
    ILabShell,
...
const factory: JupyterFrontEndPlugin<IFileBrowserFactory> = {
  ...
  id: '@evolab/filebrowser-extension:factory',
...
const shareFile: JupyterFrontEndPlugin<void> = {
  ...
  id: '@evolab/filebrowser-extension:share-file',
...
export const fileUploadStatus: JupyterFrontEndPlugin<void> = {
  id: '@evolab/filebrowser-extension:file-upload-status',
  autoStart: true,
  requires: [IFileBrowserFactory],
  optional: [IStatusBar],
  activate: (
    ...
    statusBar.registerStatusItem(
      '@evolab/filebrowser-extension:file-upload-status',
      {
        item,
        align: 'middle',
        isActive: () => {
...
function activateBrowser(
  ...
  void Promise.all([app.restored, browser.model.restored]).then(() => {
    ...
    void settingRegistry
      .load('@evolab/filebrowser-extension:browser')
      .then(settings => {
  ...
  commands.addCommand(CommandIDs.toggleNavigateToCurrentDirectory, {
    ...
    execute: () => {
      ...
      return settingRegistry
        .set('@evolab/filebrowser-extension:browser', key, value)
        .catch((reason: Error) => {
