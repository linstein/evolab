...
export class CodeCell extends Cell {
   ...
   */
  initializeState(): this {
    console.log(`initializeState wig`);
   ...
   */
  saveCollapseState() {
    console.log(`saveCollapseState wig`);
   ...
   */
  loadCollapseState() {
    console.log(`loadCollapseState wig`);
