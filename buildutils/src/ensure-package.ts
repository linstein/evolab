...
/* This file was auto-generated by {{funcName}}() in @evolab/buildutils */
`;
...
export async function ensurePackage(
  ...
  Object.keys(deps).forEach(name => {
    ...
    if (isTest) {
      const testLibs = ['jest', 'ts-jest', '@evolab/testutils'];
...
/**
 * An extra ensure function just for the @evolab/ui-components package.
 * Ensures that the icon svg import statements are synced with the contents
 * of ui-components/style/icons.
 *
 * @param pkgPath - The path to the @evolab/ui-components package.
