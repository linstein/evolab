...
import { sessionContextDialogs } from '@evolab/apputils';
import { CompletionHandler } from '@evolab/completer';
import { NotebookPanel, NotebookActions } from '@evolab/notebook';
import {
  SearchInstance,
